...
# Can you figure out the calculations for the test statistic F*?

# Remember to recode MedSchool
data_hosp$MS<-ifelse(data_hosp$MEDSCHL==1,1,ifelse(data_hosp$MEDSCHL==2, 0, NA))


# Code provided by Junting Ren ############
...
# R function to compare the models
anova(reg1, reg2)
# Note that both functions generate the same F statistic
...
anova(reg4)
# SSE(BEDS,MS)=338.77
# The partial R for INFRISK, given BEDS and MS in the model is equal to 69.54/338.77
