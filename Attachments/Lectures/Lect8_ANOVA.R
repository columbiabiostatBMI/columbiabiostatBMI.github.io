################################################################
#             Biostatistical Methods I: Lecture 8              #
#                One-Way Analysis of Variance (ANOVA)          #
#           Author: Cody Chiuzan; Date: Oct 2, 2017            #
################################################################
...
# Create box-plots 
boxplot(insulin~ind,data=new_data, main="Effect of glucose on insulin release", 
   xlab="Experimental Group", ylab="Insulin levels")
